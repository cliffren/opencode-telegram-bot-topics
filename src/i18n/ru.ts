...
export const ru: I18nDictionary = {
  ...
  "schedule.menu.button.add_once": "🗓 На дату/время",
  "schedule.menu.button.add_after": "⏳ Через время",
  "schedule.menu.button.add_daily": "🔁 Каждый день",
  "schedule.menu.button.add_weekly": "📆 Каждую неделю",
  "schedule.menu.button.add_monthly": "🗓 Каждый месяц",
  "schedule.menu.button.add_yearly": "🎉 Каждый год",
  "schedule.menu.button.list": "📋 Список задач",
  "schedule.menu.button.back": "⬅️ Назад",
  "schedule.inactive_callback": "Меню планировщика уже неактивно",
  "schedule.input.once": "Отправьте дату/время в формате: YYYY-MM-DD HH:mm",
  "schedule.input.after": "Отправьте задержку в формате: 30m или 2h",
  "schedule.input.daily": "Отправьте время в формате: HH:mm",
  "schedule.input.weekly_day": "Выберите день недели:",
  "schedule.input.weekly_time": "Отправьте время недели в формате: HH:mm",
  "schedule.input.monthly": "Отправьте формат месяца: DD HH:mm",
  "schedule.input.yearly": "Отправьте формат года: MM-DD HH:mm",
  "schedule.input.prompt": "Теперь отправьте текст задачи для запуска в текущей сессии.",
  "schedule.invalid.once": "Неверная дата/время. Используйте YYYY-MM-DD HH:mm и будущее время.",
  "schedule.invalid.after": "Неверная задержка. Используйте формат 30m или 2h.",
  "schedule.invalid.time": "Неверное время. Используйте HH:mm.",
  "schedule.invalid.monthly": "Неверный формат. Используйте DD HH:mm (день 1-31).",
  "schedule.invalid.yearly": "Неверный формат. Используйте MM-DD HH:mm.",
  "schedule.invalid.weekday": "Неверный день недели",
  "schedule.invalid.generic": "Некорректные данные планировщика. Запустите /schedule заново.",
  "schedule.create.no_session": "Нет активной сессии для этого чата/темы. Сначала выберите сессию.",
  "schedule.create.failed": "Не удалось создать отложенную задачу.",
  "schedule.created":
    "✅ Задача создана\nID: {id}\nПравило: {rule}\nСледующий запуск: {next}\nЧасовой пояс: {tz}",
  "schedule.tasks.empty": "В этом чате/теме нет отложенных задач.",
  "schedule.tasks.header": "📋 Отложенные задачи\nЧасовой пояс: {tz}",
  "schedule.tasks.item": "• [{id}] {status} | следующий: {next}\n  {rule}",
  "schedule.tasks.more": "... и еще {count}",
  ...
  "bg.notify.default_title": "Фоновая задача",
  "bg.notify.started": "🔄 Фоновая задача запущена: {title}",
  "bg.notify.done": "✅ Фоновая задача выполнена: {title}",
  "bg.notify.failed": "❌ Фоновая задача завершилась с ошибкой: {title}",
  "bg.notify.log_path": "Лог: {path}",
  ...
  "schedule.tasks.deleted_callback": "Задача удалена",
  "schedule.rule.once": "один раз в {value}",
  "schedule.rule.daily": "каждый день в {value}",
  "schedule.rule.weekly": "еженедельно {day} {time}",
  "schedule.rule.monthly": "ежемесячно {day} числа в {time}",
  "schedule.rule.yearly": "ежегодно {month}-{day} в {time}",
  "schedule.weekday.mon": "Пн",
  "schedule.weekday.tue": "Вт",
  "schedule.weekday.wed": "Ср",
  "schedule.weekday.thu": "Чт",
  "schedule.weekday.fri": "Пт",
  "schedule.weekday.sat": "Сб",
  "schedule.weekday.sun": "Вс",
  "schedule.weekday.short.0": "Вс",
  "schedule.weekday.short.1": "Пн",
  "schedule.weekday.short.2": "Вт",
  "schedule.weekday.short.3": "Ср",
  "schedule.weekday.short.4": "Чт",
